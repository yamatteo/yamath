      ...
      <div className="row">
        <div className="col-lg-12">
          ...
          <div>
            ...
            <p>L'indirizzo mail verrà utilizzato esclusivamente per inviare una mail con la password di accesso o per recuperare la password in caso di smarrimento.</p>
            <AutoForm
              app={app}
              endpoint="/api/signup"
              inputs={{
